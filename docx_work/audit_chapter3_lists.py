...
def main() -> int:
    ...
    entries = [
        ...
        ("Bảng 3.4.", "Trạng thái kiểm toán benchmark native theo cửa sổ và gate không suy biến.", 53),
        ...
        ("Hình 3.3.", "Kiến trúc mục tiêu phát hiện–quyết định–ứng phó tại nút biên; ma trận hiện tại chỉ kiểm chứng direct-BHP guard và hai cấu hình ứng phó.", 49),
